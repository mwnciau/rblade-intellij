...
class RBladeRubyLexer(highlightingMode: Boolean, private val initialState: Int = 0) : MergingLexerAdapter(RBladeRubyLexerAdapter(highlightingMode), TOKENS_TO_MERGE) {
  companion object {
